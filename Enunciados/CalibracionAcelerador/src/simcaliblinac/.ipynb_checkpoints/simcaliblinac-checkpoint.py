...
_presion_unc = 1.1
_temperatura_unc = 2.1

## Constantes de la cámara Farmen
_NDwQ0 = 0.05396
_kQ = 0.9886
...
def presion_temperatura_medida(n=1, trials=1):
    presion = _rng.normal(_presion_actual, _presion_unc, n)
    temperatura = _rng.normal(_temperatura_actual, _temperatura_unc, (trials, n))
    return presion, temperatura
...
def fugas(minutos=1, n=1, trials=1):
    return _rng.normal(_fugas_mean*minutos, _fugas_std*minutos, (trials, n))
